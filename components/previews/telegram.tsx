...
export default function TelegramPreview({ metadata, url }: PlatformPreviewProps) {
    ...
    <div className="max-w-md overflow-hidden rounded-lg bg-white text-gray-900 dark:bg-[#212121] dark:text-white">
      <div className="overflow-hidden rounded-lg bg-white dark:bg-[#212121]">
        ...
        <div className="px-3 pb-2">
          ...
          <div className="mt-1 text-xs text-gray-600 dark:text-[#aaaaaa]">{truncatedDescription}</div>
        </div>
        {image && (
          <div>
            <img
