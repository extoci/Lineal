...
export default function TwitterPreview({ metadata, url }: PlatformPreviewProps) {
  ...
  const cardType = metadata.twitterCard === "summary_large_image" || image ? "summary_large_image" : "summary"
      ...
      <div className="w-full max-w-[520px] overflow-hidden rounded-2xl border border-gray-200 bg-white text-gray-900 dark:border-[#2f3336] dark:bg-[#16181c] dark:text-[#e7e9ea]">
        <div className="flex h-[131px]">
          {image ? (
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  if (container) {
                    ...
                    svg.setAttribute("class", "h-8 text-gray-400 dark:text-[#71767b]")
                    svg.innerHTML =
            ...
            <div className="flex shrink-0 items-center justify-center w-[130px] border-r border-gray-200 bg-gray-50 dark:border-[#2f3336] dark:bg-[#16181c]">
              <svg viewBox="0 0 24 24" aria-hidden="true" className="h-8 text-gray-400 dark:text-[#71767b]">
                <g>
                  <path
          ...
          <div className="flex flex-1 flex-col justify-center gap-0.5 p-3">
            <div className="text-xs text-gray-500 dark:text-[#71767b]">{domain}</div>
            <div className="overflow-hidden text-ellipsis whitespace-nowrap pr-2 text-base font-medium text-gray-900 dark:text-[#e7e9ea]">
              {title}
            </div>
            <div className="line-clamp-2 text-xs text-gray-500 dark:text-[#71767b]">{description}</div>
          </div>
        </div>
      </div>
    )
